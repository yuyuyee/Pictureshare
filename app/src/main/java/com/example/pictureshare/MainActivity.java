...
import com.example.pictureshare.add.addp;
import com.example.pictureshare.login.LoginActivity;
import com.example.pictureshare.login.mineAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,ListView.OnItemClickListener{
    ...
    private List<com.example.pictureshare.show.Ph> dataList = new ArrayList<>();
    public static final String MESSAGE_STRING = "com.example.pictureshare.MESSAGE";
        ...
        Button adv_btn_fanhui = (Button) findViewById(R.id.adv_btn_fanhui);
            ...
            public void onClick(View view) {
                ...
                mine.setImageResource(R.drawable.ic_baseline_account_box_24_back);
                 List<com.example.pictureshare.mine> mines = new ArrayList<>();
    ...
    public void show(){
        ...
        List<com.example.pictureshare.show.Ph> psList = new ArrayList<>();
        ...
        while (cursor.moveToNext())
        {
            ...
            int i = 0;
            int j = 0;
            com.example.pictureshare.show.Ph news =new com.example.pictureshare.show.Ph();
        ...
        //显示图片页面
        com.example.pictureshare.show.PAdapter newsAdapter = new com.example.pictureshare.show.PAdapter(MainActivity.this,
